...
{
    public partial class CallSendAsyncProgApi
    {
        /// <summary>
        ...
        public void CallSendAsyncProgApiCode(int CncId, string DocumentName, string DocExtension, string SourceFolder, string User,
