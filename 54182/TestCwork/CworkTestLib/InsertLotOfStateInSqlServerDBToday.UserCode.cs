...
{
    public partial class InsertLotOfStateInSqlServerDBToday
    {
        /// <summary>
        ...
        private void ClearStatesTablesTableContents(Int32 cnc)
        {
            ...
            try {
            	...
            	// delete entry in table
  				OleDbCommand  maCommande = conn.CreateCommand();
				maCommande.CommandType = CommandType.Text;
				maCommande.CommandText = "DELETE FROM cworkstatestable WHERE stastationhandlefield = ?";
        ...
        public void InsertStatesIntoDbSqlServerToday(int StateDuration, int CncId, string CncName)
        {
