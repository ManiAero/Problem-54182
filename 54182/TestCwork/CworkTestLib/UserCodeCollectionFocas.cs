...
{
	/// <summary>
	/// code from https://github.com/versex799/FanucFocasTutorial/blob/master/FanucFocasTutorial/fwlib32.cs
	/// </summary>
	public class Focas1
	{
		/* Axis define */
		...
		[StructLayout(LayoutKind.Sequential,CharSet=CharSet.Ansi,Pack=4)]
		public class ODBPDFADIRS
		{
			public ODBPDFADIR dir1 = new ODBPDFADIR();
			public ODBPDFADIR dir2 = new ODBPDFADIR();
			public ODBPDFADIR dir3 = new ODBPDFADIR();
			public ODBPDFADIR dir4 = new ODBPDFADIR();
			public ODBPDFADIR dir5 = new ODBPDFADIR();
			public ODBPDFADIR dir6 = new ODBPDFADIR();
			public ODBPDFADIR dir7 = new ODBPDFADIR();
			public ODBPDFADIR dir8 = new ODBPDFADIR();
			public ODBPDFADIR dir9 = new ODBPDFADIR();
			public ODBPDFADIR dir10 = new ODBPDFADIR();
			public ODBPDFADIR dir11 = new ODBPDFADIR();
			public ODBPDFADIR dir12 = new ODBPDFADIR();
			public ODBPDFADIR dir13 = new ODBPDFADIR();
			public ODBPDFADIR dir14 = new ODBPDFADIR();
			public ODBPDFADIR dir15 = new ODBPDFADIR();
			public ODBPDFADIR dir16 = new ODBPDFADIR();
			public ODBPDFADIR dir17 = new ODBPDFADIR();
			public ODBPDFADIR dir18 = new ODBPDFADIR();
			public ODBPDFADIR dir19 = new ODBPDFADIR();
			public ODBPDFADIR dir20 = new ODBPDFADIR();
			public ODBPDFADIR dir21 = new ODBPDFADIR();
			public ODBPDFADIR dir22 = new ODBPDFADIR();
			public ODBPDFADIR dir23 = new ODBPDFADIR();
			public ODBPDFADIR dir24 = new ODBPDFADIR();
			public ODBPDFADIR dir25 = new ODBPDFADIR();
			public ODBPDFADIR dir26 = new ODBPDFADIR();
			public ODBPDFADIR dir27 = new ODBPDFADIR();
			public ODBPDFADIR dir28 = new ODBPDFADIR();
			public ODBPDFADIR dir29 = new ODBPDFADIR();
			public ODBPDFADIR dir30 = new ODBPDFADIR();
			public ODBPDFADIR dir31 = new ODBPDFADIR();
			public ODBPDFADIR dir32 = new ODBPDFADIR();
			public ODBPDFADIR dir33 = new ODBPDFADIR();
			public ODBPDFADIR dir34 = new ODBPDFADIR();
			public ODBPDFADIR dir35 = new ODBPDFADIR();
			public ODBPDFADIR dir36 = new ODBPDFADIR();
			public ODBPDFADIR dir37 = new ODBPDFADIR();
			public ODBPDFADIR dir38 = new ODBPDFADIR();
			public ODBPDFADIR dir39 = new ODBPDFADIR();
			public ODBPDFADIR dir40 = new ODBPDFADIR();
			public ODBPDFADIR dir41 = new ODBPDFADIR();
			public ODBPDFADIR dir42 = new ODBPDFADIR();
			public ODBPDFADIR dir43 = new ODBPDFADIR();
			public ODBPDFADIR dir44 = new ODBPDFADIR();
			public ODBPDFADIR dir45 = new ODBPDFADIR();
			public ODBPDFADIR dir46 = new ODBPDFADIR();
			public ODBPDFADIR dir47 = new ODBPDFADIR();
			public ODBPDFADIR dir48 = new ODBPDFADIR();
			public ODBPDFADIR dir49 = new ODBPDFADIR();
			public ODBPDFADIR dir50 = new ODBPDFADIR();
		}
		
//		public class ODBPDFADIR2
//		{
//			public List<ODBPDFADIR> dirs;
//
//			// Constructeur qui prend le nombre de lignes comme paramètre
//			public ODBPDFADIR2(int nligne)
//			{
//				dirs = new List<ODBPDFADIR>(nligne);
//				for (int i = 0; i < nligne; i++)
//				{
//					dirs.Add(new ODBPDFADIR());
//				}
//			}
//		}
	...
	/// </summary>
	[UserCodeCollection]
	public class UserCodeCollectionFocas
	{
		...
		/// <summary>
		/// Test if file existe in CNC
		/// </summary>
		[UserCodeMethod]
		public static void CheckIfFileExistInCnc(string path, string fileName, string CncIp)
		{
			try
			{
				// get connexion handle
				_ret = Focas1.cnc_allclibhndl3(CncIp, 8193, 6, out _handle);
				if (_ret != Focas1.EW_OK)
				{
					Report.Failure("Validation", "Unable to connect to "+CncIp+" on port 8193\n\nReturn Code: "+ _ret.ToString());
				}
				else
				{
					Report.Log(ReportLevel.Info, "Our Focas handle is "+_handle.ToString());
//				// get program list cnc_rdprogdir3
//				Focas1.PRGDIR3 prgDir = new Focas1.PRGDIR3();
//				short num;
//				int top = 0;
//				short ret;
//
...
//					{
//						num = BUFSIZE;
//						// Appel de la fonction non managée pour remplir prgDir
//						ret = Focas1.cnc_rdprogdir3(_handle, 0, ref top, ref num, prgDir);
//
...
//						if (ret != Focas1.EW_OK)
//						{
//							Report.Log(ReportLevel.Info, "ERROR: " + ret.ToString());
//							break;
//						}
//
//						// Afficher les numéros de chaque PRGDIR3_data dans prgDir
//						for (int i = 0; i < num; i++)
//						{
//							// Accéder à chaque PRGDIR3_data via la réflexion ou en les énumérant explicitement
//							var prgDataList = new List<Focas1.PRGDIR3_data>
//							{
//								prgDir.dir1,
//								prgDir.dir2,
//								prgDir.dir3,
...
//							};
//
//							if (i < prgDataList.Count)
//							{
//								var prgData = prgDataList[i];
//								Report.Log(ReportLevel.Info, "O" + prgData.number.ToString());
//								top = prgData.number + 1;
//							}
//						}
//					} while (num >= BUFSIZE);
//				}
...
//					Focas1.ODBPDFADIR pdf_adir_out = new Focas1.ODBPDFADIR();
						...
						_ret = Focas1.cnc_rdpdf_alldir(_handle,ref num_prog,  pdf_adir_in, pdf_adir_outs);
						if (_ret != Focas1.EW_OK)
						{
							Report.Log(ReportLevel.Info, "ERROR: " + _ret.ToString());
						}
						else
						{
							try
							{
								Report.Log(ReportLevel.Info, "num_prog: " + num_prog.ToString());
								
								
//							// Accéder à chaque ODBPDFADIR via la réflexion ou en les énumérant explicitement
//							var prgDataList = new List<Focas1.ODBPDFADIR>
//							{
//								pdf_adir_outs.dir1,
//								pdf_adir_outs.dir2,
//								pdf_adir_outs.dir3
//							};
								...
								{
									string prop_name="dir" + (i+1).ToString();
									var prop = typeof(Focas1.ODBPDFADIRS).GetField(prop_name);
									if (prop != null)
									{
										var prgData = prop.GetValue(pdf_adir_outs) as Focas1.ODBPDFADIR;
										if (prgData != null)
										{
											prgDataList.Add(prgData);
										}
									}
								}
								bool textFound = false;
								// listage des fichiers trouvé et recherche si fichier existe
								for (int i = 0; i < num_prog; i++)
								{
									var prgData = prgDataList[i];
									Report.Log(ReportLevel.Info, prgData.d_f );
									if (prgData.d_f.Equals(fileName))
									{
										textFound = true;
									}
								}
								...
								if (textFound)
								{
									Report.Success("Validation",  path + " contains "+ fileName);
								}else
								{
									Report.Failure("Validation", path + "  do not contains "+ fileName);;
								}
								
								
							}
							catch  (Exception ex) {
								Report.Log(ReportLevel.Error, "Exception1: " + ex.Message);
							}
					...
					{
						Report.Log(ReportLevel.Error, "Exception2: " + ex.Message);
					}
					finally
					{
						// Pas nécessaire si prgDir est une classe gérée
			...
			{
				Report.Log(ReportLevel.Error, "Exception0: " + ex.Message);
			}
		...
		/// </summary>
		[UserCodeMethod]
		public static void DeleteFile(string path, string fileName, string CncIp)
		{
			try
			{
				Report.Log(ReportLevel.Info, "DeleteFile: " + path + fileName);
				// get connexion handle
				_ret = Focas1.cnc_allclibhndl3(CncIp, 8193, 6, out _handle);
				if (_ret != Focas1.EW_OK)
				{
				...
				{
					Report.Log(ReportLevel.Info, "Our Focas handle is "+_handle.ToString());
					// use 	public static extern short cnc_pdf_del( ushort FlibHndl, [In,MarshalAs(UnmanagedType.AsAny)] Object a );*
						_ret = Focas1.cnc_pdf_del(_handle, path+fileName);
						if (_ret != Focas1.EW_OK)
						{
							Report.Log(ReportLevel.Info, "ERROR: " + _ret.ToString());
						}
						...
						{
							Report.Log(ReportLevel.Info, "del " + path+fileName + " done");
						}
				}
			}
			catch (Exception ex)
		...
		/// </summary>
		[UserCodeMethod]
		public static void AddDir(string path, string CncIp)
		{
			try
			{
				Report.Log(ReportLevel.Info, "AddDir "+ path );
				// get connexion handle
				_ret = Focas1.cnc_allclibhndl3(CncIp, 8193, 6, out _handle);
				if (_ret != Focas1.EW_OK)
				{
				...
				{
					Report.Log(ReportLevel.Info, "Our Focas handle is "+_handle.ToString());
					// use 	public static extern short cnc_pdf_add( ushort FlibHndl, [In,MarshalAs(UnmanagedType.AsAny)] Object a );*
						_ret = Focas1.cnc_pdf_add(_handle, path);
						if (_ret != Focas1.EW_OK)
						{
							Report.Log(ReportLevel.Info, "ERROR: " + _ret.ToString());
						}
						...
						{
							Report.Log(ReportLevel.Info, "Add " + path + " done");
						}
				}
			}
			catch (Exception ex)
