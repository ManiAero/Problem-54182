...
{
    public partial class TestAddStateTimeLine
    {
        /// <summary>
        ...
        public void CheckBMonoEditConfirmExist()
        {
            ...
            String BMonoEditConfirmStr = repo.CWork2021951.HistoryTimelineView.BMonoEditConfirm.GetPath().ToString();
            System.DateTime timeBefore = System.DateTime.Now;  
            Validate.Exists(BMonoEditConfirmStr, 10000);
