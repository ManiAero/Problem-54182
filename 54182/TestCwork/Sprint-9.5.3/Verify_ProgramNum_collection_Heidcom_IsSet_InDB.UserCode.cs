...
{
    public partial class Verify_ProgramNum_collection_Heidcom_IsSet_InDB
    {
        /// <summary>
        ...
        public void CheckProgramNumEventInDb(int EventValue)
        {
        	...
        	string query = "SELECT cncevtprogtype FROM cnctable WHERE cncpk = 1";
